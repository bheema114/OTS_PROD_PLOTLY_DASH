    ...
    --card_type,
                ...
                FROM
                    (
                        ...
                        WHERE
                            TO_DATE(transaction_date_time, 'yyyy-mm-dd hh24:mi:ss') 
                            BETWEEN TO_DATE('20231216 00:00:00', 'yyyy-mm-dd hh24:mi:ss'
                            ) AND TO_DATE('20231216 23:00:00', 'yyyy-mm-dd hh24:mi:ss')
                            AND a.equipment_id = decode(1, 1, a.equipment_id, 1)
                            AND a.station_id = decode(1, 1, a.station_id, 1)
