...
FROM
    (
        ...
        WHERE
            ...
            AND pay_md = decode(1, 1, pay_md, 1)
        GROUP BY
        ...
        WHERE
            ...
            a.equp_id = decode(1, 1, a.equp_id, 1)
            AND a.station_id = decode(1, 1, a.station_id, 1)
            AND plt_pay_md = decode(1, 1, plt_pay_md, 1)
        GROUP BY
            trunc(TO_DATE(a.trx_dt_tm, 'yyyy-mm-dd hh24:mi:ss')),
            a.station_id,
            b.station_name,
        ...
        WHERE
            ...
            --TO_DATE(m.trx_dt_tm, 'yyyy-mm-dd hh24:mi:ss') BETWEEN TO_DATE('20230914 00:00:00', 'yyyy-mm-dd hh24:mi:ss') AND TO_DATE('20230914 23:59:59'
            --, 'yyyy-mm-dd hh24:mi:ss')
            ...
            AND payment_method = decode(1, 1, payment_method, 1)
        GROUP BY
        ...
        WHERE
            ...
            --TO_DATE(transaction_date_time, 'yyyy-mm-dd hh24:mi:ss') BETWEEN TO_DATE('20230914 00:00:00', 'yyyy-mm-dd hh24:mi:ss') AND TO_DATE
            --('20230914 23:59:59', 'yyyy-mm-dd hh24:mi:ss')
             a.equipment_id = decode(1, 1, a.equipment_id, 1)
            AND a.station_id = decode(1, 1, a.station_id, 1)
            AND payment_mode = decode(1, 1, payment_mode, 1)
        GROUP BY
