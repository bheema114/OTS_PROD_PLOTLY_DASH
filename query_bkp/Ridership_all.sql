...
FROM
    (
        ...
        WHERE
            ...
            AND TO_DATE(m.insert_date, 'yyyy-mm-dd hh24:mi:ss') = TO_DATE(sysdate, 'yyyy-mm-dd hh24:mi:ss')
            --m.insert_date BETWEEN 
            --TO_DATE('20230914 00:00:00', 'yyyy-mm-dd hh24:mi:ss') AND TO_DATE('20230914 23:59:59', 'yyyy-mm-dd hh24:mi:ss')
