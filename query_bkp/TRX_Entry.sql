        ...
        FROM
            (
                SELECT
                    ...
                    b.product_type
                FROM
                    tb_emv_trx_gate_entry_tag a,
                    tb_emv_card_type b
                WHERE
                    a.crd_type = b.product_id
                    AND
                    TO_DATE(trx_dt_tm, 'yyyy-mm-dd hh24:mi:ss') BETWEEN TO_DATE('20230901 00:00:00', 'yyyy-mm-dd hh24:mi:ss') AND TO_DATE
                    ('20230901 23:59:59', 'yyyy-mm-dd hh24:mi:ss')
            ) c
        GROUP BY (
            c.insert_date,
            c.entrystationid,
